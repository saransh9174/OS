...
int main() {
    ...
    int idx;
    int context_switches = 0; // Track context switches
    ...
    while (completed != n) {
        ...
        if (burst_remaining[idx] - tq > 0) {
            ...
            current_time += tq;
            context_switches++; // Increment context switch count
        }
        else {
    ...
    cout << "Total Context Switches = " << context_switches-1 << endl; // Output the total context switches
